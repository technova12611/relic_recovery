...
/**
 * Created by terryw on 7/22/2016.
 */
...
public class CheesyDriveHelper {
    ...
    // Drive tuning
    public static final double sensitivityHigh = .75;
    public static final double sensitivityLow = .75;

    public CheesyDriveHelper(final DcMotor leftDrive, final DcMotor rightDrive) {
    ...
    public void cheesyDrive(double throttle, double wheel, boolean isQuickTurn, boolean isHighGear) {
        ...
        this.leftDrive.setPower(leftPwm);
        this.rightDrive.setPower(rightPwm);
    }
