            ...
            switch (step) {
                    ...
                    switch (vuMark) {
                        ...
                        case RIGHT:
                            if(getAllianceColor() ==  AllianceColor.RED) {
                                ...
                                driveBackwardInches(3.0, motorSpeed, 1.5);

                            }
                            // if this is BLUE Alliance
                            else {
                                driveForwardInches(16.25, motorSpeed, 3.0);
                            }
                            break;
                        ...
                        case CENTER:
                            ...
                            // if this is BLUE Alliance
                                ...
                                driveForwardInches(8.0, motorSpeed, 2.0);
                            }
                            break;
                ...
                case PICKUP_ANOTHER_GLYPH:
                    ...
                    if(do4Glyphs()) {
                        ...
                        driveForwardInches(6.0, 0.35, 1.5);
                        sleepInAuto(200);

                        driveBackwardInches(6.0, 0.35, 1.5);

                        //turn(-87.0);

                        robot.pushGlyph();

                        driveBackwardInches(12.0,0.50,3.0);
                        robot.holdPusher();
...
//                        }
                ...
                case FORWARD_TO_CRYPTOBOX:
                    ...
                    if(do4Glyphs()) {
                        robot.pushGlyph();
                        driveBackwardInchesToColumn(8.50, 0.15, 3.0);
                        robot.holdPusher();
                    ...
                    if(getRuntime() > 22.0 || !pickupMoreGlyphs()) {
                        ...
                        if(getAllianceColor() == AllianceColor.RED) {
                            ...
                            if (vuMark == RelicRecoveryVuMark.LEFT) {
                                driveRightInches(oneColumnDistance + 6.5, fasterMotorSpeed, 2.0);
                            } else {
                ...
                case PICKUP_MORE_GLYPH:
                    ...
                    if(getAllianceColor() == AllianceColor.RED) {
                        turnToAngle(-73.5, 0.20);
                    } else {
                        turnToAngle(-105.5, 0.20);
                    }
                ...
                case PLACE_MORE_GLYPHS_INTO_CRYPTO:
                    ...
                    if( (robot.columnDetected() != null && !robot.columnDetected()) || (columnDist > 7.0 && columnDist < 100)) {
                        ...
                        driveBackwardInchesToColumn(7.25, 0.18, 2.0);
                    }
