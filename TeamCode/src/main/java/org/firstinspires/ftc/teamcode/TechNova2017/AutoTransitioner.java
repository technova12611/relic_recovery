 ...
 *      AutoTransitioner.transitionOnStop(this, "RegularWheelRobot Teleop");
 * Where 'RegularWheelRobot Teleop' is replaced with the NAME of your teleop program. See full documentation
