 ...
 * Created by FTC 9915
 */
@Autonomous(name="Auto Blue 2 Alliance", group="9915 Blue")
@Disabled
public class VelocityVortexAutoBLUE4 extends ETC2016AutoBaseOpMode {
    ...
    public VelocityVortexAutoBLUE4() {
    }
...
//------------------------Change wait time as necessary------------------------------------
            ...
            case TURN_90_DEGREES:
                ...
                if(this.robot.mediumTurn(-135.0))
                {
                    goToNextState();
                }
                break;
            ...
            case MOVE_TO_VORTEX:
                ...
                if (this.robot.setPowerRunToPosition(0.75, 0.75, (int)(COUNTS_PER_INCH*48.0))) {
                    goToNextState();
                }
